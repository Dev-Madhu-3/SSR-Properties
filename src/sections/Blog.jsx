...
const blogPosts = [
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/djuoignk5/image/upload/v1774808812/SSR_SG_uti012.jpg',
    author: 'Mr.Surendra',
    date: 'Feb 13, 2026',
    readTime: '1 min read',
    category: 'Investment',
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button onClick={() => onViewPost(featuredPost.id)} variant="ghost" className="text-[#c89b3c]">
                      Read More
